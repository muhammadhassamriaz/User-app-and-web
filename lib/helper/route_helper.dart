...
class RouteHelper {
  ...
  static Handler _orderDetailsHandler = Handler(
    ...
    return _routeHandler(
        child: _orderDetailsScreen != null
            ? _orderDetailsScreen
            : OrderDetailsScreen(
  ...
  static Handler _menuHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: MenuScreen()));

  static Handler _loginHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: LoginScreen()));

  static Handler _forgetPassHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: ForgotPasswordScreen()));

  static Handler _signUpHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: SignUpScreen()));
  ...
  static Handler _verificationHandler = Handler(
    ...
    return _routeHandler(
        child: _verificationScreen != null
            ? _verificationScreen
            : VerificationScreen(
  ...
  static Handler _createAccountHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: CreateAccountScreen()));
  ...
  static Handler _updateAddressHandler = Handler(
    ...
    return _routeHandler(
        child: _addNewAddressScreen != null
  ...
  static Handler _orderSuccessHandler =
    ...
    return _routeHandler(
        child:
            OrderSuccessfulScreen(orderID: params['id'][0], status: _status));
  });
  ...
  static Handler _notificationHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: NotificationScreen()));
  ...
  static Handler _productDescriptionHandler = Handler(
    ...
    return _routeHandler(
        child:
            Container()); //_descriptionScreen != null ? _descriptionScreen : DescriptionScreen(description: _data));
  });
  ...
  static Handler _productDetailsHandler = Handler(
    ...
    return _routeHandler(
        child:
            ProductDetailsScreen(product: _product, fromSearch: _fromSearch));
  });
  ...
  static Handler _productImagesHandler = Handler(
    ...
    return _routeHandler(
      child: _productImageScreen != null
          ? _productImageScreen
          : ProductImageScreen(
              title: params['name'][0],
  ...
  static Handler _profileHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: ProfileScreen()));

  static Handler _searchProductHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: SearchScreen()));
  ...
  static Handler _cartHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: CartScreen()));
  ...
  static Handler _profileMenusHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: MenuWidget()));
  static Handler _myOrderHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: MyOrderScreen()));
  static Handler _addressHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: AddressScreen()));
  static Handler _couponHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: CouponScreen()));
  ...
  static Handler _settingsHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) =>
          _routeHandler(child: SettingsScreen()));
  static Handler _termsHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
          child: HtmlViewerScreen(htmlType: HtmlType.TERMS_AND_CONDITION)));

  static Handler _policyHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
          child: HtmlViewerScreen(htmlType: HtmlType.PRIVACY_POLICY)));

  static Handler _aboutUsHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: HtmlViewerScreen(htmlType: HtmlType.ABOUT_US)));
  static Handler _faqHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: HtmlViewerScreen(htmlType: HtmlType.FAQ)));
  ...
  static Handler _maintenanceHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: MaintenanceScreen()));
  static Handler _contactHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: ContactScreen()));

  static Handler _updateHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: UpdateScreen()));
  ...
  static Handler _favoriteHandler = Handler(
      handlerFunc: (context, Map<String, dynamic> params) =>
          _routeHandler(child: WishListScreen()));
  ...
  static Handler _returnPolicyHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
        child: HtmlViewerScreen(htmlType: HtmlType.RETURN_POLICY)),
  );

  static Handler _refundPolicyHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
        child: HtmlViewerScreen(htmlType: HtmlType.REFUND_POLICY)),
  );

  static Handler _cancellationPolicyHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) => _routeHandler(
        child: HtmlViewerScreen(htmlType: HtmlType.CANCELLATION_POLICY)),
  );
