                          ...
                          if (orderProvider.isActiveOrder) {
                            ...
                            List<OrderDetailsModel> orderDetails =
                                await (orderProvider.getOrderDetails(
                                        ...
                                        context)
                                    as FutureOr<List<OrderDetailsModel>>);
                            ...
                            await Future.forEach(orderDetails,
                              ...
                              if (_product != null) {
                                ...
                                if (Provider.of<CartProvider>(context,
                                    ...
                                    null) {
                                  _errorMessage =
                                      '${_cartModel.product!.name} ${getTranslated('is_already_in_cart', context)}';
                                } else if (_cartModel.stock! < 1) {
                                  _errorMessage =
                                      '${_cartModel.product!.name} ${getTranslated('is_out_of_stock', context)}';
                                } else {
