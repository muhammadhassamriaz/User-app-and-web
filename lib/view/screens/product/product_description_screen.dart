...
//     return Scaffold(
//       appBar: (ResponsiveHelper.isDesktop(context) ? MainAppBar() : CustomAppBar(title: getTranslated('description', context), isBackButtonExist: true)) as PreferredSizeWidget?,
//      body: Center(
//        child: Container(
//          width: 1170,
